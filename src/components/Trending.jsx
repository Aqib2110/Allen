  ...
  return (
    <div className='lg:h-[200vh]  md:h-[120vh] bg-[#EDF2FA]'>
      ...
      <div className='lg:mt-25 mt-12'>
        ...
        <div className='mt-8'>
            <img src="toppers.avif" className=' w-29/30 hidden sm:block rounded-3xl md:h-[600px] mx-auto' alt="" />
            <img src="3.jpg" className=' w-27/30 rounded-3xl block sm:hidden h-[500px] mx-auto' alt="" />
        </div>
<div className='mt-8 '>
