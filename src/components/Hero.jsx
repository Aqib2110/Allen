...
<h1 className='font-bold font-[Plus-Jakarta-Sans] lg:w-[600px] flex justify-center items-center  text-center text-[1.5rem]  sm:pt-0 sm:text-[35px] pt-6  pl-0 lg:pl-6 w-full'>Online coaching that delivers results</h1>
