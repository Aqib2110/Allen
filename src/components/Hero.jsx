...
const Hero = () => {
  return (
    <>
        <div className='lg:h-[110vh] md:h-[93vh]  bg-[#DCEDF8] pt-[133px] py-6 w-[100%]'> 
            <div className='border-blue-900 gap-18 lg:gap-35 xl:gap-18 lg:flex w-3/4 mx-auto'>
            <div className='lg:w-1/2 w-full flex  flex-col justify-center '>
<h1 className='font-bold font-[Plus-Jakarta-Sans] lg:w-[600px] flex justify-center items-center text-[35px]  pl-0 lg:pl-6 w-full'>Online coaching that delivers results</h1>
<p className='font-bold pt-12 pl-0 flex lg:flex-none justify-center lg:pl-6 text-[#494A4A]'>Explore our online courses</p>
...
<span className='border-2 border-[#0555B1] text-[13px] font-bold text-center cursor-pointer self-center px-5 py-2.5 rounded-3xl'>Class 6-10</span>
        ...
        <div className='fit-content lg:flex-none flex justify-center lg:my-0 my-8'>
            <img src="allen.avif" alt="" className='h-[220px] lg:w-[360px] xl:w-[400px]' />
        </div>
            </div>
