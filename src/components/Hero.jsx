...
<h1 className='font-bold font-[Plus-Jakarta-Sans] lg:w-[600px] flex justify-center items-center text-[22px] pt-6 sm:pt-0 sm:text-[35px]  pl-0 lg:pl-6 w-full'>Online coaching that delivers results</h1>
